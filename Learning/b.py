...
# bin function takes any number and interprets it in binary system as zeros and ones. (starts wuth '0b')
print("x =", x, "=", bin(x))
...
# Zero fill left shift / Shift right by pushing copies of the leftmost bit in from the left, and let the rightmost bits fall off / basicly multiplies number by 2
print('y<<1', bin(y << 1))
